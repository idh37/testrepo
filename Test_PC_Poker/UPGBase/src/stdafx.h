...
#define UPG_LOBBY_EXPORT	__declspec(dllimport)
#define UPG_GAME_EXPORT		__declspec(dllimport)
#define UPG_BASE_EXPORT		__declspec(dllexport)
...
#include "UPGNewPoker.h"
#include "UPG7Poker.h"
#include "UPGLowBD.h"
#include "UPGHighLow.h"
#include "UPGSutda.h"
#include "UPGHoola.h"
