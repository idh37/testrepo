...
#define UPG_LOBBY_EXPORT	__declspec(dllexport)
...
#include "ObjectID.h"
#include "../include/UPGLobby.h"
#include "./ImageLobbyDef.h"

#pragma comment (lib, "winmm.lib")


#define FONT_LOBBY_DEFAULT (FONT_DEFAULT)
#define COLOR_TAB_BUTTON_NORMAL (RGB(96,98,100))
#define COLOR_TAB_BUTTON_DOWN (RGB(96,98,100))
#define COLOR_TAB_BUTTON_OVER (RGB(120,123,125))
