...
void CJackpotMoney::OnCreated(void)
{
	SetUseLogic(true);
}

void CJackpotMoney::Logic(const DWORD &dwTime)
{
...
CHalfJackpotMoney::CHalfJackpotMoney()
{
}
...
void CHalfJackpotMoney::OnCreated(void)
{
	SetUseLogic(true);
}

void CHalfJackpotMoney::Logic(const DWORD &dwTime)
{
