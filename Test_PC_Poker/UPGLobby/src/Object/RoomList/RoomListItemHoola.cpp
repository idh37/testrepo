...
CRoomListItemHoola::CRoomListItemHoola()
:	m_pRoomNumber(NULL),
	m_pMinmumMoney(NULL),
	m_pTitle(NULL),
	m_pSeedMoney(NULL),
...
void CRoomListItemHoola::OnCreateChild(LSY::CObjectBase *pObject)
{
	if(pObject == NULL) return;

	switch(pObject->GetID())
	{
	case ID_LOBBY_TXTNB_ROOMLISTITEM_NO_HOOLA:			m_pRoomNumber			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_TXT_ROOMLISTITEM_GAMESTYLE_HOOLA:		m_pGameStyle			= (LSY::CText *)pObject;		break;	
	case ID_LOBBY_TXT_ROOMLISTITEM_MINMONEY_HOOLA:		m_pMinmumMoney			= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_TITLE_HOOLA:          m_pTitle				= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXTNB_ROOMLISTITEM_SEEDMONEY_HOOLA:	m_pSeedMoney			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_TXT_ROOMLISTITEM_GAMEMODE_HOOLA:		m_pStopMode				= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_GAMETYPE_HOOLA:		m_pJokerMode			= (LSY::CText *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_MODE_HOOLA:			m_pImg_Mode				= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_TXTNB_ROOMLISTITEM_PLAYERCNT_HOOLA:   m_pPlayerCnt			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_IMG_ROOMLISTITEM_GAMESTYLE_HOOLA:		m_pImg_Gamestyle		= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_SEEDMONEY_HOOLA:		m_pImg_SeedMoney		= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_FULLUSER_HOOLA:		m_pImg_FullUser			= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_BTN_ROOMLISTITEM_ENTER_ROOM_HOOLA:	m_pBtnEnterRoom			= (LSY::CButton *)pObject;		break;
	case ID_LOBBY_BTN_ROOMLISTITEM_OBSERVER_ROOM_HOOLA:	m_pBtnObserberRoom		= (LSY::CButton *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_PREVROOM_HOOLA:		m_pTitle_PrevRoom		= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_PREVTITLE_HOOLA:		m_pTitle_PrevRoomTitle	= (LSY::CText *)pObject;		break;
	}

	__super::OnCreateChild(pObject);
}

void CRoomListItemHoola::OnCreated(void)
{
	__super::OnCreated();
}

LSY::CObjectBase *CRoomListItemHoola::NewObject(void)
{
	return new CRoomListItemHoola;
}

void CRoomListItemHoola::UpdateData(const LPARAM &lParam)
{
...
void CRoomListItemHoola::SetBarType(int nStartIndex)
{
...
void CRoomListItemHoola::OnMouseOver(void)
{
	__super::OnMouseOver();
	UpdateData(0);
}

void CRoomListItemHoola::OnMouseLeave(void)
{
