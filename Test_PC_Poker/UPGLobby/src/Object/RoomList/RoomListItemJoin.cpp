...
CRoomListItemJoin::CRoomListItemJoin()
:	m_pRoomNumber(NULL),
	m_pMinmumMoney(NULL),
	m_pTitle(NULL),
	m_pGameMode(NULL),
...
void CRoomListItemJoin::OnCreateChild(LSY::CObjectBase *pObject)
{
	if(pObject == NULL) return;

	switch(pObject->GetID())
	{
	case ID_LOBBY_TXTNB_ROOMLISTITEM_NO_JOIN:			m_pRoomNumber			= (LSY::CTextNumber *)pObject;	break;
	//case ID_LOBBY_TXT_ROOMLISTITEM_GAMESTYLE_JOIN:		m_pGameStyle			= (LSY::CText *)pObject;		break;		
	case ID_LOBBY_TXT_ROOMLISTITEM_MINMONEY_JOIN:		m_pMinmumMoney			= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_TITLE_JOIN:           m_pTitle				= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_GAMEMODE_JOIN:		m_pGameMode				= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXTNB_ROOMLISTITEM_SEEDMONEY_JOIN:		m_pSeedMoney			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_TXT_ROOMLISTITEM_RULE_JOIN:			m_pRule					= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXTNB_ROOMLISTITEM_PLAYERCNT_JOIN:		m_pPlayerCnt			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_IMG_ROOMLISTITEM_MODE_JOIN:			m_pImg_Mode				= (LSY::CImage *)pObject;		break;
	//case ID_LOBBY_IMG_ROOMLISTITEM_GAMESTYLE_JOIN:		m_pImg_Gamestyle		= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_LIMIT_JOIN:			m_pImg_Limit			= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_SEEDMONEY_JOIN:		m_pImg_SeedMoney		= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_FULLUSER_JOIN:		m_pImg_FullUser			= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_BTN_ROOMLISTITEM_ENTER_ROOM_JOIN:		m_pBtnEnterRoom			= (LSY::CButton *)pObject;		break;
	case ID_LOBBY_BTN_ROOMLISTITEM_OBSERVER_ROOM_JOIN:	m_pBtnObserberRoom		= (LSY::CButton *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_PREVROOM_JOIN:		m_pTitle_PrevRoom		= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_PREVTITLE_JOIN:		m_pTitle_PrevRoomTitle	= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_CARDSETTING_JOIN:		m_pCardSetting			= (LSY::CText *)pObject;		break;		
		
// 	case ID_LOBBY_IMG_RoomListItemJoin_USER0:
// 	case ID_LOBBY_IMG_RoomListItemJoin_USER1:
// 	case ID_LOBBY_IMG_RoomListItemJoin_USER2:
// 	case ID_LOBBY_IMG_RoomListItemJoin_USER3:
// 	case ID_LOBBY_IMG_RoomListItemJoin_USER4:
// 		m_listUserCount[pObject->GetID() - ID_LOBBY_IMG_RoomListItemJoin_USER0] = (LSY::CImage *)pObject;
// 		break;
	}
...
void CRoomListItemJoin::OnCreated(void)
{
	LSY::CObjectProject *pProject = GetObjectMan()->GetProjectFromID(ID_LOBBY);
	__super::OnCreated();
}

LSY::CObjectBase *CRoomListItemJoin::NewObject(void)
{
	return new CRoomListItemJoin;
}


void CRoomListItemJoin::UpdateData(const LPARAM &lParam)
{
	...
	//	bJoinable = TRUE; 		//직전방 RoomListItemJoin의 Look은 bJoinable이 FALSE라도 TRUE처럼 보이게한다.
...
void CRoomListItemJoin::SetBarType(int nStartIndex)
{
...
void CRoomListItemJoin::OnMouseOver(void)
{
	__super::OnMouseOver();
	UpdateData(0);
}

void CRoomListItemJoin::OnMouseLeave(void)
{
	__super::OnMouseLeave();
	UpdateData(0);
}

// void CRoomListItemJoin::SetUserCount(int nUserCount, bool bJoinable)
// {
// 	for(int i =0; i< DEF_MAX_USERS; i++) 
// 	{
