...
CRoomListItemLowBD::CRoomListItemLowBD()
:	m_pRoomNumber(NULL),
	m_pMinmumMoney(NULL),
	m_pTitle(NULL),
	m_pSeedMoney(NULL),
...
void CRoomListItemLowBD::OnCreateChild(LSY::CObjectBase *pObject)
{
	if(pObject == NULL) return;

	switch(pObject->GetID())
	{
	case ID_LOBBY_TXTNB_ROOMLISTITEM_NO_LOWBD:			m_pRoomNumber			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_TXT_ROOMLISTITEM_GAMESTYLE_LOWBD:		m_pGameStyle			= (LSY::CText *)pObject;		break;		
	case ID_LOBBY_TXT_ROOMLISTITEM_MINMONEY_LOWBD:		m_pMinmumMoney			= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_TITLE_LOWBD:          m_pTitle				= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXTNB_ROOMLISTITEM_SEEDMONEY_LOWBD:	m_pSeedMoney			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_TXT_ROOMLISTITEM_RULE_LOWBD:			m_pRule					= (LSY::CText *)pObject;		break;
	//case ID_LOBBY_TXT_ROOMLISTITEM_GAMEMODE_LOWBD:		m_pGameMode				= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXTNB_ROOMLISTITEM_PLAYERCNT_LOWBD:   m_pPlayerCnt			= (LSY::CTextNumber *)pObject;	break;
//	case ID_LOBBY_TXTNB_ROOMLISTITEM_TOTOALMONEY_LOWBD:	m_pTatalMoney			= (LSY::CTextNumber *)pObject;	break;
	case ID_LOBBY_IMG_ROOMLISTITEM_GAMESTYLE_LOWBD:		m_pImg_Gamestyle		= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_SEEDMONEY_LOWBD:		m_pImg_SeedMoney		= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_IMG_ROOMLISTITEM_FULLUSER_LOWBD:		m_pImg_FullUser			= (LSY::CImage *)pObject;		break;
	case ID_LOBBY_BTN_ROOMLISTITEM_ENTER_ROOM_LOWBD:	m_pBtnEnterRoom			= (LSY::CButton *)pObject;		break;
	case ID_LOBBY_BTN_ROOMLISTITEM_OBSERVER_ROOM_LOWBD:	m_pBtnObserberRoom		= (LSY::CButton *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_PREVROOM_LOWBD:		m_pTitle_PrevRoom		= (LSY::CText *)pObject;		break;
	case ID_LOBBY_TXT_ROOMLISTITEM_PREVTITLE_LOWBD:		m_pTitle_PrevRoomTitle	= (LSY::CText *)pObject;		break;
...
void CRoomListItemLowBD::OnCreated(void)
{
	//LSY::CObjectProject *pProject = GetObjectMan()->GetProjectFromID(ID_LOBBY);
	__super::OnCreated();
}

LSY::CObjectBase *CRoomListItemLowBD::NewObject(void)
{
	return new CRoomListItemLowBD;
}

void CRoomListItemLowBD::UpdateData(const LPARAM &lParam)
{
...
void CRoomListItemLowBD::SetBarType(int nStartIndex)
{
...
void CRoomListItemLowBD::OnMouseOver(void)
{
	__super::OnMouseOver();
	UpdateData(0);
}

void CRoomListItemLowBD::OnMouseLeave(void)
{
	__super::OnMouseLeave();
	UpdateData(0);
}

// void CRoomListItemLowBD::SetUserCount(int nUserCount, bool bJoinable)
// {
// 	for(int i =0; i< DEF_MAX_USERS; i++) 
// 	{
