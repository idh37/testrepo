...
CRoomListHeaderHoolaJoin::CRoomListHeaderHoolaJoin(void)
:	m_pTabRoomType(NULL),
...
void CRoomListHeaderHoolaJoin::OnCreateChild(LSY::CObjectBase *pObject)
{
	...
	{
	case ID_LOBBY_TAB_ROOM_LIST_HOOLA_JOIN:				m_pTabRoomType					= (LSY::CTabControl *)pObject;		break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_NO_HOOLA_JOIN:		m_pBtnRoomNumber			= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_MINMONEY_HOOLA_JOIN:	m_pBtnMinimumMoney		= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_TITLE_HOOLA_JOIN:		m_pBtnTitle				= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_SEEDMONEY_HOOLA_JOIN:	m_pBtnSeedMoney			= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_USERCOUNT_HOOLA_JOIN:	m_pBtnUserCount			= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_DEFAULT_SORT_HOOLA_JOIN: m_pBtnDefaultSort		= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_GAMEMODE_HOOLA_JOIN:	m_pBtnGameMode			= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
//	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_RULETYPE_HOOLA_JOIN:	m_pBtnRuleType			= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
//	case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_TOTALMONEY_HOOLA_JOIN:m_pBtnRoomTotalMoney	= (LSY::CTextButton *)pObject;	bAddChild = true;	break;
//	case ID_LOBBY_BTN_ROOMLIST_HEADER_DEFAULT_SORT_HOOLA_JOIN:	m_pBtnDefaultSort		= (LSY::CButton *)pObject;		bAddChild = true;	break;
	case ID_LOBBY_LIST_ROOM_HOOLA_JOIN:							m_pList					= (LSY::CList *)pObject;			break;
	}

	if(bAddChild)
	{
		pObject->AddHandler(LSY::EM_O_MOUSELCLICK, LSY::Fnt(this, &CRoomListHeaderHoolaJoin::OnClickButton));
	}

	__super::OnCreateChild(pObject);
}

void CRoomListHeaderHoolaJoin::OnCreated(void)
{
	...
	m_pTabRoomType->AddHandler(LSY::EM_O_SELCHANGE, LSY::Fnt(this, &CRoomListHeaderHoolaJoin::OnRoomTypeSelChange));

	m_pList->AddHandler(LSY::EM_O_LISTITEM_CLICK, LSY::Fnt(this, &CRoomListHeaderHoolaJoin::OnListItemLClick));
	m_pList->AddHandler(LSY::EM_O_LISTITEM_DBCLICK, LSY::Fnt(this, &CRoomListHeaderHoolaJoin::OnListItemLDbClick));

	LSY::CListItem *pListItem = m_pList->GetItem();
	LSY::CButton *pEnterRoom = (LSY::CButton *)pListItem->GetFirstChildFromID(ID_LOBBY_BTN_ROOMLISTITEM_ENTER_ROOM_HOOLA_JOIN);
	pEnterRoom->AddHandler(LSY::EM_O_MOUSELCLICK, LSY::Fnt(this, &CRoomListHeaderHoolaJoin::OnClickEnterRoom));

	LSY::CButton *pObserverRoom = (LSY::CButton *)pListItem->GetFirstChildFromID(ID_LOBBY_BTN_ROOMLISTITEM_OBSERVER_ROOM_HOOLA_JOIN);
	pObserverRoom->AddHandler(LSY::EM_O_MOUSELCLICK, LSY::Fnt(this, &CRoomListHeaderHoolaJoin::OnClickObserverRoom));
...
LRESULT CRoomListHeaderHoolaJoin::OnClickButton(LSY::CMessage *msg)
{
	...
	switch(pBtn->GetID())
	{
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_NO_HOOLA_JOIN:
		{
		...
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_MINMONEY_HOOLA_JOIN:
		{
			#ifdef UPGRADE_10210619_ADD_CLICKLOG
		...
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_TITLE_HOOLA_JOIN:
		{
			#ifdef UPGRADE_10210619_ADD_CLICKLOG
		...
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_SEEDMONEY_HOOLA_JOIN:
		{
			#ifdef UPGRADE_10210619_ADD_CLICKLOG
		...
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_USERCOUNT_HOOLA_JOIN:
		{
			#ifdef UPGRADE_10210619_ADD_CLICKLOG
		...
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_DEFAULT_SORT_HOOLA_JOIN:
		{
			#ifdef UPGRADE_10210619_ADD_CLICKLOG
		...
		case ID_LOBBY_TXTBTN_ROOMLIST_HEADER_GAMEMODE_HOOLA_JOIN:
		{
			#ifdef UPGRADE_10210619_ADD_CLICKLOG
...
void CRoomListHeaderHoolaJoin::Sort(int nSortType)
{
...
void CRoomListHeaderHoolaJoin::SortDefault(void)
{
...
void CRoomListHeaderHoolaJoin::SortEnterRoomMinimumMoney(INT64 *i64Money)
{
...
void CRoomListHeaderHoolaJoin::ChangeRoomTab( ROOMLIST_TYPE eRoomListType )
{
	UINT nID = ID_LOBBY_RAD_VIP_ROOM_LIST_HOOLA_JOIN;

	if (eRoomListType==ROOMLIST_TYPE_NORMAL)
		nID = ID_LOBBY_RAD_NORMAL_ROOM_LIST_HOOLA_JOIN;
	else if (eRoomListType==ROOMLIST_TYPE_FREE)
		nID = ID_LOBBY_RAD_FREE_ROOM_LIST_HOOLA_JOIN;
...
void CRoomListHeaderHoolaJoin::AddDataRoomList()
{
	RemoveAll();
...
LRESULT CRoomListHeaderHoolaJoin::OnRoomTypeSelChange(LSY::CMessage *msg)
{
...
void CRoomListHeaderHoolaJoin::SetJoinable( bool bstate )
{
	m_bJoinable = bstate;
}


void CRoomListHeaderHoolaJoin::RemoveAll(void)
{
	m_pList->DeleteAllItem();
}

void CRoomListHeaderHoolaJoin::AddItem(SMALLROOMINFO *pRoomInfo)
{
...
void CRoomListHeaderHoolaJoin::DelItem(SMALLROOMINFO *pRoomInfo)
{
	m_pList->DeleteItem((LPARAM)pRoomInfo);
}

void CRoomListHeaderHoolaJoin::ChangeItem(SMALLROOMINFO *pRoomInfo)
{
	m_pList->UpdateItemFromParam((LPARAM)pRoomInfo);
}

void CRoomListHeaderHoolaJoin::SetListEnable(bool bEnable)
{
	m_pList->SetEnable(bEnable);
}

LRESULT CRoomListHeaderHoolaJoin::OnListItemLClick(LSY::CMessage *msg)
{
...
LRESULT CRoomListHeaderHoolaJoin::OnListItemLDbClick(LSY::CMessage *msg)
{
...
LRESULT CRoomListHeaderHoolaJoin::OnClickEnterRoom(LSY::CMessage *msg)
{
...
LRESULT CRoomListHeaderHoolaJoin::OnClickObserverRoom(LSY::CMessage *msg)
{
...
void CRoomListHeaderHoolaJoin::RemoveSelectedRoom(void)
{
...
void CRoomListHeaderHoolaJoin::ChangeRoomList()
{    
	m_pTabRoomType->GetFirstChildFromID(ID_LOBBY_RAD_VIP_GOLD_ROOM_LIST_HOOLA_JOIN)->SetShow(false);
	m_pTabRoomType->GetFirstChildFromID(ID_LOBBY_RAD_NORMAL_GOLD_ROOM_LIST_HOOLA_JOIN)->SetShow(false);
}