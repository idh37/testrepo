...
#define g_PLAYER(nPlayerPos)	((CPlayerHoola*)GM().GetCurrentProcess()->GetPlayer(nPlayerPos))	// 플레이어를 찾는 전역 함수
#define g_GAMEPROCESS()			((CGameProcessHoola*)GM().GetCurrentProcess())						// 게임프로세스 오브젝트 포인터


extern CGameViewHoola*	g_pGameView;		// GameView Pointer
...
extern CUIInfoDataHoola g_cUIData;
