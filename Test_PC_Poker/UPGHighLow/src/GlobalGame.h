...
#define g_PLAYER(nPlayerPos)	((CPlayerHighLow*)GM().GetCurrentProcess()->GetPlayer(nPlayerPos))	// 플레이어를 찾는 전역 함수
#define g_GAMEPROCESS()			((CGameProcessHighLow*)GM().GetCurrentProcess())						// 게임프로세스 오브젝트 포인터


extern CGameViewHighLow*	g_pGameView;		// GameView Pointer
...
extern CUIInfoDataHighLow g_cUIData;
