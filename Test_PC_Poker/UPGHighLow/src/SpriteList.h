...
extern NMBASE::GRAPHICGDI::xSprite g_sprHighLowSwingEfc;		//하이로우 이펙트
extern NMBASE::GRAPHICGDI::xSprite g_sprHighLowSwingBtn;		//하이로우스윙 선택 버튼
extern NMBASE::GRAPHICGDI::xSprite g_sprHighLowSwing_ResultSelectCase;		//하이로우 선택 결과
