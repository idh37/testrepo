...
#include "./GameHelper/JokboProbability7Poker.h"
#include "./GameHelper/OtherUserJokboCheckMan7Poker.h"
...
CGameView7Poker::CGameView7Poker(CGame *pGame)
...
CGameView7Poker::~CGameView7Poker()
{
}


BEGIN_MESSAGE_MAP(CGameView7Poker, CGameViewBase)
	//{{AFX_MSG_MAP(CGameView7Poker)
	ON_WM_PAINT()
	ON_WM_TIMER()
	ON_WM_CREATE()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CGameView7Poker message handlers

BOOL CGameView7Poker::PreCreateWindow(CREATESTRUCT& cs) 
{
...
int CGameView7Poker::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CGameView7Poker::OnInit(void)
{
	if(m_bOnceInit)
	{
		return;
	...
	{	
		m_cPlayerDrawManager.AddPlayer(g_GAMEPROCESS()->GetPlayer(nNum), new CPlayerDraw, nNum);
	}
...
LRESULT CGameView7Poker::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	switch(message)
	{
	case WM_MOUSEWHEEL:
...
//	NMBASE::SOUND::g_Sound.RegularCall();
	...
	m_cBackGround.DrawTop(&Page, &MemDC);
	// 사이드팟
...
void CGameView7Poker::DrawJackPot()
{		
...
void CGameView7Poker::Reset()
{
	m_bExitSubscript = FALSE;	
}

void CGameView7Poker::OnTimer(UINT nIDEvent) 
{
...
void CGameView7Poker::OnDestroy() 
{
...
BOOL CGameView7Poker::OnCommand(WPARAM wParam, LPARAM lParam) 
{	
...
void CGameView7Poker::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CGameView7Poker::DrawPlayCard(CDC *pDC)
{	
	if(GetCurrentWhere() != IDX_GAMEWHERE_GAME)
	{
		return;
...
void CGameView7Poker::DrawPlayBottom(CDC *pDC)
{
...
void CGameView7Poker::DrawPlayMiddle(CDC *pDC)
{
...
void CGameView7Poker::DrawPlayTop(CDC *pDC)
{
...
void CGameView7Poker::DrawButton(CDC *pDC)
{
...
//2006.1.9 스피드핵
DWORD CGameView7Poker::GetCurrentPlayTick()
{
	return timeGetTime()-g_nStartTick;
}


BOOL CGameView7Poker::NoticAreaMouseOver(int x, int y )
{	
	return FALSE;
}


void CGameView7Poker::SetupByConfig()
{
...
void CGameView7Poker::ShowEffect_AllowChancePurchase(int nItemCode)
{
...
// 보유한도 달성 이펙트
void CGameView7Poker::ShowEffect_OwnLimitEffect(int nPnum)
{
...
//UPG 작업 추가
void CGameView7Poker::ShowEffect_OwnLimitIcon(BOOL bON, INT64 llMoney)
{
}


void CGameView7Poker::OnExitRoom(void)
{
}

const int CGameView7Poker::GetWidth()
{
	return 1000;
}

const int CGameView7Poker::GetHeight()
{
	return 740;
}

BOOL CGameView7Poker::OnEraseBkgnd(CDC* pDC)
{	
	OnPaint();
...
BOOL CGameView7Poker::PreTranslateMessage(MSG* pMsg)
{
...
void CGameView7Poker::GameViewSetFocus()
{
	if(this)
	{
		this->SetFocus(); 
