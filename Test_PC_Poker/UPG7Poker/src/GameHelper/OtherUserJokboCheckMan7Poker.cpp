#include "stdafx.h"
#include "OtherUserJokboCheckMan7Poker.h"
...
COtherUserJokboCheckMan7Poker::COtherUserJokboCheckMan7Poker()
{
	Clear();
	m_bUse = false;
}
...
bool COtherUserJokboCheckMan7Poker::get_Pair( int pnum )
{
	if( pnum <= 0 || 
...
bool COtherUserJokboCheckMan7Poker::get_One( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
		m_Other_User[pnum].m_cBaseCardInfo.m_nTotalCardCount <= 1 )
...
bool COtherUserJokboCheckMan7Poker::get_Two( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
...
bool COtherUserJokboCheckMan7Poker::get_Three( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
...
bool COtherUserJokboCheckMan7Poker::get_Straight( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
		m_Other_User[pnum].m_cBaseCardInfo.m_nTotalCardCount <= 2 )
...
bool COtherUserJokboCheckMan7Poker::get_Flush( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
		m_Other_User[pnum].m_cBaseCardInfo.m_nTotalCardCount <= 2 )
...
bool COtherUserJokboCheckMan7Poker::get_House( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
...
bool COtherUserJokboCheckMan7Poker::get_Four( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
		m_Other_User[pnum].m_cBaseCardInfo.m_nTotalCardCount <= 3 )
...
bool COtherUserJokboCheckMan7Poker::get_St_Flush( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
		m_Other_User[pnum].m_cBaseCardInfo.m_nTotalCardCount <= 2 )
...
bool COtherUserJokboCheckMan7Poker::get_Rst_Flush( int pnum )
{
	if( pnum <= 0 || 
		pnum >= MAX_POSSIBLE_PLAYER || 
		m_Other_User[pnum].m_cBaseCardInfo.m_nTotalCardCount <= 2 )
...
void COtherUserJokboCheckMan7Poker::Init(NMBASE::GRAPHICGDI::xSprite *pArrowSpr)
{
	COtherUserJokboCheckMan::Init(pArrowSpr);
	m_bUse = true;
}

void COtherUserJokboCheckMan7Poker::Clear(void)
{
...
void COtherUserJokboCheckMan7Poker::Draw(CDC *pDC , NMBASE::GRAPHICGDI::CPage *pPage)
{
...
void COtherUserJokboCheckMan7Poker::CheckJokbo(void)
{
