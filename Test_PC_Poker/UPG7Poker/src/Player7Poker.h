...
class CPlayer7Poker  : public CPlayer
{
public:
...
public:
	...
	void SetCardTotal(int nCount)
	{
		...
		char szTemp1[256] = {0, };
		sprintf(szTemp1, "------ CPlayer7Poker::SetCardTotal => TotalCardCount:%d , OpenCardCont:%d \n", m_nCardTotalCount, m_nOpenCardTotalCount);
...
// 	void SetDieFlag(BOOL bFlagInput){bFold = bFlagInput;}
	...
	//buy in 입장제한방에서 보우금액 업데이트를 위한 함수 추가
	INT64 GetNowMoney();
