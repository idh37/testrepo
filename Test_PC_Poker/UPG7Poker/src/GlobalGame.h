...
#define g_PLAYER(nPlayerPos)	((CPlayer7Poker*)GM().GetCurrentProcess()->GetPlayer(nPlayerPos))	// 플레이어를 찾는 전역 함수
#define g_GAMEPROCESS()			((CGameProcess7Poker*)GM().GetCurrentProcess())						// 게임프로세스 오브젝트 포인터


extern CGameView7Poker*	g_pGameView;		// GameView Pointer
...
extern CUIInfoData7Poker g_cUIData;
