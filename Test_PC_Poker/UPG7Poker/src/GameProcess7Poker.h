// GameProcess7Poker.h: interface for the CGameProcess7Poker class.
//
//////////////////////////////////////////////////////////////////////
...
class CGameProcess7Poker : public CGameProcess
{
public:
	CGameProcess7Poker(CGame *pGame);
	virtual ~CGameProcess7Poker();
...
public:
	...
	CPlayer7Poker* GetPlayerNP(int i);
...
protected:
	CPlayer7Poker			m_cPlayer[MAX_NEWPLAYER];		// 최대 플레이어를 미리 생성한다.(플레이어:5, 관전자:10)
