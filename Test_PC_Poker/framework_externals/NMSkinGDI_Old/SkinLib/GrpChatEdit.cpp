// GrpChatEdit.cpp: implementation of the CGrpChatEdit class.
//
//////////////////////////////////////////////////////////////////////
...
namespace NMBASE
{
	namespace SKINGDI
	{
		...
		BEGIN_MESSAGE_MAP(CGrpChatEdit, CChatViewEdit)
		...
		void CGrpChatEdit::PreSubclassWindow() 
		{
		...
		void CGrpChatEdit::Init(void)
		{
			...
			//m_SkinVerticleScrollbar.LoadBtnImage();		// 버튼 이미지 읽기
			...
			//	CRect(windowRect.right,windowRect.top,windowRect.right+m_SkinVerticleScrollbar.m_Thumb.x,windowRect.bottom), pParent);
		...
		void CGrpChatEdit::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp) 
		{
			/*****************************************************************
		...
		void CGrpChatEdit::OnSize(UINT nType, int cx, int cy) 
		{
		...
		BOOL CGrpChatEdit::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt) 
		{
			//m_SkinVerticleScrollbar.UpdateThumbPosition();
		...
		void CGrpChatEdit::OnFontChange() 
		{
		...
		void CGrpChatEdit::UpdateScrollSize(void)
		{
			// 	CHARFORMAT cf;
