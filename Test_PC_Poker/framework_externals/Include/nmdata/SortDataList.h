...
@brief   데이터 Sort Template 클래스 ( 이전 : CFilterDataList)
*/
...
namespace NMBASE
{
	namespace DATA
	{
		...
		public:
			...
			virtual void Clear()
			{
				class list<DATAENTITY*>::iterator it = m_list_data.begin();
			...
			{
				class list<DATAENTITY*>::iterator it = find_if( m_list_data.begin(), m_list_data.end(), CFindKey(key));
		...
		template <class K, class D>
		class NMDATA_CLASS CSortDataList : public CDataList<K, D>
		{
		public:	
		...
		public:	
			...
			virtual BOOL DelData(K key)
			{
				...
				{
					class list<DATAENTITY*>::iterator it = find_if( it_map->second.begin(), it_map->second.end(), CFindKey(key));
			...
			virtual DATAENTITY *ChangeData(K key, D *data)
			{
				...
				{			
					...
					{			
						...
						class list<DATAENTITY*>::iterator it_list = find_if( it_map->second.begin(), it_map->second.end(), CFindKey(key));
