...
//	CDataRoomList	m_DataRoomList;//게임방리스트	
//	CDataRoomOptionList m_DataRoomOptionList;//머니구간정보(채널정보)
...
public:
	...
	virtual LONG OnPacketNotify(int Sid, int Signal, int TotSize, char *lpData) = 0;
	virtual LRESULT ShowCreateRooomDlg(ROOMINFO *pRoomInfo) = 0;
