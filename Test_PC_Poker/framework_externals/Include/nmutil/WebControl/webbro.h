...
namespace NMBASE
{
	namespace UTIL
	{
		...
		class NMUTIL_CLASS CWebBrowser2 : public CWnd
		{
		protected:
		...
		public:
			...
			void GoHome();
			void GoSearch();
			void Navigate(LPCTSTR URL, VARIANT* Flags =NULL, VARIANT* TargetFrameName = NULL, VARIANT* PostData = NULL, VARIANT* Headers = NULL);
			void Refresh();
