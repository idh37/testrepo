...
#define WINVER 0x0400           // 다른 버전의 Windows에 맞도록 적합한 값으로 변경해 주십시오.
#endif

#ifndef _WIN32_WINNT            // 필요한 최소 플랫폼을 Windows Vista로 지정합니다.
#define _WIN32_WINNT 0x0400     // 다른 버전의 Windows에 맞도록 적합한 값으로 변경해 주십시오.
#endif
...
#define _WIN32_IE 0x0400        // 다른 버전의 IE에 맞도록 적합한 값으로 변경해 주십시오.
#endif
