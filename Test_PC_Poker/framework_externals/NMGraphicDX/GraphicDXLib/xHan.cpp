...
static char outline_temp1[128]; 
static char outline_temp2[128];	// 아웃라인 생성용 임시 버퍼
...
/*-----------------------------------------------------------------------------
	...
	color : 출력할 색상
-------------------------------------------------------------------------------*/
void xHan::put_font( int x, int y, int xl, int yl, char *buf, WORD *tar, int bgr, WORD bgrColor, int type, WORD color)
{
    int i,j,m=0,n=0;
    unsigned char mask = 0x80;        // = 10000000b
	int xsize, size;
