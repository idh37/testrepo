...
static AFX_EXTENSION_MODULE NMSockDLL = { NULL, NULL };
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	{
		TRACE0("NMSock.DLL을 초기화하고 있습니다.\n");
		
		// 확장 DLL을 한 번만 초기화합니다.
		if(!AfxInitExtensionModule(NMSockDLL, hInstance))
			return 0;
		...
		new CDynLinkLibrary(NMSockDLL);

	}
	else if(dwReason == DLL_PROCESS_DETACH)
	{
		TRACE0("NMSock.DLL을 종료하고 있습니다.\n");
		...
		AfxTermExtensionModule(NMSockDLL);
	}
	return 1;   // 확인
}
