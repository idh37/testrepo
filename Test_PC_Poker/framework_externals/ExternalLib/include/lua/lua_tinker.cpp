...
#ifdef _DEBUG
#pragma comment(lib, "lua514_MTd.lib")
#pragma message( "[lua514_MTd.lib] library Link" )
#else
#pragma comment(lib, "lua514_MT.lib")
#pragma message( "lua514_MT.lib] library Link" )
#endif
