#ifndef __BASECONNECTORDISPATCHER__H__
#define __BASECONNECTORDISPATCHER__H__
...
namespace BaseConnector
{
	...
	public:
		Dispatch()	{	}
		virtual ~Dispatch()	{}
		virtual bool init (Camel::Dar::PacketHeader& rHeader, Camel::Base::System::Stream::Handle hStream, int nPacketSize) = 0;
	...
	public:
		bool init ( Camel::Dar::PacketHeader& rHeader, Camel::Base::System::Stream::Handle hStream, int nPacketSize)
		{
			int nBeforeStreamSize = Camel::Base::System::Stream::GetLength( hStream);

			bool bChangeByteOrder = (rHeader.GetPacketEndianType() != Camel::Dar::GetSystemEndianType());
			if ( false == darmsgptr_->Load(hStream, Camel::Dar::IDarMsg::STREAM, bChangeByteOrder))
			{
				return false;
			}
	...
	public:
		...
		bool DoDispatch ( Camel::Dar::PacketHeader& rHeader, Camel::Base::System::Stream::Handle hstream, int nPacketSize )
		{
...
#endif //__BASECONNECTORDISPATCHER__H__