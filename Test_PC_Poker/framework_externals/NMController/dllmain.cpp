...
static AFX_EXTENSION_MODULE NMControllerDLL = { NULL, NULL };
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	{
		TRACE0("NMController.DLL을 초기화하고 있습니다.\n");
		
		// 확장 DLL을 한 번만 초기화합니다.
		if(!AfxInitExtensionModule(NMControllerDLL, hInstance))
			return 0;
		...
		new CDynLinkLibrary(NMControllerDLL);

	}
	else if(dwReason == DLL_PROCESS_DETACH)
	{
		TRACE0("NMController.DLL을 종료하고 있습니다.\n");
		...
		AfxTermExtensionModule(NMControllerDLL);
	}
	return 1;   // 확인
}
