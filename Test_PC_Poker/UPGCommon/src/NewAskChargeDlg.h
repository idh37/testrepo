...
{	
	...
	NEW_ASK_CHARGE_DLG_TYPE_INSU_GOLD,		//골드 보험 팝업
	NEW_ASK_CHARGE_DLG_TYPE_INSU_GOLD2,		//골드 보험금 지급 팝업
...
class UPG_COMMON_EXPORT CNewAskChargeDlg : public CUPGDlgBase
{
// Construction
protected:
	...
	NMBASE::SKINGDI::CMyButton m_BtnX;
