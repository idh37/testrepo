	...
	namespace Dar
	{
		namespace TMS
		{
			namespace EliminateReason
			{
				...
				#if !defined __Dar2Enum_TMS_EliminateReason_type__MessageId_1878723979__
				#define __Dar2Enum_TMS_EliminateReason_type__MessageId_1878723979__
				enum type
				{
				...
				#endif     // !defined __Dar2Enum_TMS_EliminateReason_type__MessageId_1878723979__
			}
		}
		namespace TMS
		{
			namespace EnterRoomType
			{
				...
				#if !defined __Dar2Enum_TMS_EnterRoomType_Type__MessageId_418762918__
				#define __Dar2Enum_TMS_EnterRoomType_Type__MessageId_418762918__
				enum Type
				{
					StartTournament = 0,
					Rematching = 1,
				...
				#endif     // !defined __Dar2Enum_TMS_EnterRoomType_Type__MessageId_418762918__
			}
		}
		namespace TMS
		{
			namespace ErrorCode
			{
				...
				#if !defined __Dar2Enum_TMS_ErrorCode_Type__MessageId_4245915489__
				#define __Dar2Enum_TMS_ErrorCode_Type__MessageId_4245915489__
				enum Type
				{
					Success = 0,
					Error = 1,
				...
				#endif     // !defined __Dar2Enum_TMS_ErrorCode_Type__MessageId_4245915489__
			}
		}
		namespace TMS
		{
			namespace GameOverState
			{
				...
				#if !defined __Dar2Enum_TMS_GameOverState_Type__MessageId_1700531115__
				#define __Dar2Enum_TMS_GameOverState_Type__MessageId_1700531115__
				enum Type
				{
					Win = 0,
					Lose = 1,
				...
				#endif     // !defined __Dar2Enum_TMS_GameOverState_Type__MessageId_1700531115__
			}
		}
		namespace TMS
		{
			namespace LeaveReason
			{
				...
				#if !defined __Dar2Enum_TMS_LeaveReason_Type__MessageId_3247604440__
				#define __Dar2Enum_TMS_LeaveReason_Type__MessageId_3247604440__
				enum Type
				{
					Eliminated = 0,
					ExitRoom = 1,
				...
				#endif     // !defined __Dar2Enum_TMS_LeaveReason_Type__MessageId_3247604440__
			}
		}
		namespace TMS
		{
			namespace State
			{
				...
				#if !defined __Dar2Enum_TMS_State_Type__MessageId_193348664__
				#define __Dar2Enum_TMS_State_Type__MessageId_193348664__
				enum Type
				{
					None = 0,
					Enterable = 1,
				...
				#endif     // !defined __Dar2Enum_TMS_State_Type__MessageId_193348664__
			}
		}
		namespace TMS
		{
			namespace UserPosition
			{
				...
				#if !defined __Dar2Enum_TMS_UserPosition_Type__MessageId_48176342__
				#define __Dar2Enum_TMS_UserPosition_Type__MessageId_48176342__
				enum Type
				{
					None = 0,
					Lobby = 1,
				...
				#endif     // !defined __Dar2Enum_TMS_UserPosition_Type__MessageId_48176342__
			}
		}

		#if !defined __Dar2MessageProtocol_TMS_Header__MessageId_4003000291__
		#define __Dar2MessageProtocol_TMS_Header__MessageId_4003000291__
		namespace TMS
		{
			class Header : public Camel::Dar2::IDarMsg
			{
			public:
				...
				// GetLength Function
				virtual int GetLength( Camel::Dar2::IDarMsg::ProtocolRule eRule = Camel::Dar2::IDarMsg::STREAM)
				{
					// Stream Format
					if ( Camel::Dar2::IDarMsg::STREAM == eRule)
					{
				...
				// Save Function
				virtual bool Save(Base::System::Stream::Handle stream, Camel::Dar2::IDarMsg::ProtocolRule eRule = Camel::Dar2::IDarMsg::STREAM)
				{
					// Stream Format
					if ( Camel::Dar2::IDarMsg::STREAM == eRule)
					{
				...
				virtual bool Load(Base::System::Stream::Handle stream, Camel::Dar2::IDarMsg::ProtocolRule eRule = Camel::Dar2::IDarMsg::STREAM, bool bRequireChangeByteOrder = false)
				{
					// STREAM Format
					int nStreamSize = Camel::Base::System::Stream::GetLength(stream);
					Camel::Dar2::MessageBlock clBlock;
				...
				bool Load(Camel::Dar2::MessageBlock& rMessageBlock, Camel::Dar2::IDarMsg::ProtocolRule eRule = Camel::Dar2::IDarMsg::STREAM, bool bRequireChangeByteOrder = false)
				{
				...
				{
					// Save Member nSeqKey
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<unsigned int>( stream, nSeqKey))		{    return false;     }

					return true;
				}

				bool _LoadSTREAM( Camel::Dar2::MessageBlock& clMessageBlock, bool bRequireChangeByteOrder = false)
				{
					// Load Member nSeqKey
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<unsigned int>( clMessageBlock, nSeqKey, bRequireChangeByteOrder))		{    return false;     }
					return true;
				}

				#if defined(__JSON_LIB_SUPPORT__)
				// save JSON Format
				virtual bool SaveJSON(std::string& strJsonFormat, Camel::Dar2::IDarMsg::JSONOutFormat eFormat = Camel::Dar2::IDarMsg::FAST) const
				{
					Json::Value Json_root;
					if (false == SaveJSON(Json_root))	{	return false;	}
					if ( Camel::Dar2::IDarMsg::FAST == eFormat )	{	Json::FastWriter writer;	strJsonFormat = writer.write(Json_root);	}
				...
				bool LoadJSON(const Json::Value& Json_root)
				{
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nSeqKey"], nSeqKey))	{	return false;	}
					}
					return true;
				}
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_Header__MessageId_4003000291__

		#if !defined __Dar2MessageProtocol_TMS_RoomInfo__MessageId_1351664208__
		#define __Dar2MessageProtocol_TMS_RoomInfo__MessageId_1351664208__
		namespace TMS
		{
			class RoomInfo : public Camel::Dar2::IDarMsg
			{
			public:
				...
				bool _SaveSTREAM( Base::System::Stream::Handle stream)
				{
					...
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nGameCode))		{    return false;     }
					// Save Member nServerCode
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nServerCode))		{    return false;     }
					// Save Member nRoomNum
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nRoomNum))		{    return false;     }
					// Save Member nRoomKey
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<__int64>( stream, nRoomKey))		{    return false;     }
					// Save Member strRoomCreator
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save( stream, strRoomCreator))		{    return false;     }
					// Save Member strTitle
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save( stream, strTitle))		{    return false;     }
				...
				bool _LoadSTREAM( Camel::Dar2::MessageBlock& clMessageBlock, bool bRequireChangeByteOrder = false)
				{
					...
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nGameCode, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nServerCode
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nServerCode, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nRoomNum
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nRoomNum, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nRoomKey
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<__int64>( clMessageBlock, nRoomKey, bRequireChangeByteOrder))		{    return false;     }
					// Load Member strRoomCreator
					if (false == Camel::Dar2::DAR2Rule_STREAM::Load( clMessageBlock, strRoomCreator, bRequireChangeByteOrder))		{    return false;     }
					// Load Member strTitle
					if (false == Camel::Dar2::DAR2Rule_STREAM::Load( clMessageBlock, strTitle, bRequireChangeByteOrder))		{    return false;     }
					return true;
				}
				...
				bool LoadJSON(const Json::Value& Json_root)
				{
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nGameCode"], nGameCode))	{	return false;	}
					}
					// Load Member nServerCode
					if (! Json_root["nServerCode"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nServerCode"], nServerCode))	{	return false;	}
					}
					// Load Member nRoomNum
					if (! Json_root["nRoomNum"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nRoomNum"], nRoomNum))	{	return false;	}
					}
					// Load Member nRoomKey
					if (! Json_root["nRoomKey"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nRoomKey"], nRoomKey))	{	return false;	}
					}
					// Load Member strRoomCreator
					if (! Json_root["strRoomCreator"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["strRoomCreator"], strRoomCreator))	{	return false;	}
					}
					// Load Member strTitle
					if (! Json_root["strTitle"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["strTitle"], strTitle))	{	return false;	}
					}
					return true;
				}
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_RoomInfo__MessageId_1351664208__

		#if !defined __Dar2MessageProtocol_TMS_UserInfo__MessageId_2961065544__
		#define __Dar2MessageProtocol_TMS_UserInfo__MessageId_2961065544__
		namespace TMS
		{
			class UserInfo : public Camel::Dar2::IDarMsg
			{
			public:
				...
				{
					// Save Member strId
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save( stream, strId))		{    return false;     }
					// Save Member strNickname
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save( stream, strNickname))		{    return false;     }
					// Save Member llChips
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<__int64>( stream, llChips))		{    return false;     }
					// Save Member ePos
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<Camel::Dar::TMS::UserPosition::Type>( stream, ePos))		{    return false;     }
					// Save Member nGameCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nGameCount))		{    return false;     }
					// Save Member nRank
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nRank))		{    return false;     }
				...
				{
					// Load Member strId
					if (false == Camel::Dar2::DAR2Rule_STREAM::Load( clMessageBlock, strId, bRequireChangeByteOrder))		{    return false;     }
					// Load Member strNickname
					if (false == Camel::Dar2::DAR2Rule_STREAM::Load( clMessageBlock, strNickname, bRequireChangeByteOrder))		{    return false;     }
					// Load Member llChips
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<__int64>( clMessageBlock, llChips, bRequireChangeByteOrder))		{    return false;     }
					// Load Member ePos
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<Camel::Dar::TMS::UserPosition::Type>( clMessageBlock, ePos, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nGameCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nGameCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nRank
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nRank, bRequireChangeByteOrder))		{    return false;     }
					return true;
				}
				...
				bool LoadJSON(const Json::Value& Json_root)
				{
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["strId"], strId))	{	return false;	}
					}
					// Load Member strNickname
					if (! Json_root["strNickname"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["strNickname"], strNickname))	{	return false;	}
					}
					// Load Member llChips
					if (! Json_root["llChips"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["llChips"], llChips))	{	return false;	}
					}
					// Load Member ePos
					if (! Json_root["ePos"].isNull())
					{
						int temp;
						if (false == DAR2Rule_JSON::Load(Json_root["ePos"], temp))	{	return false;	}
						ePos = static_cast<Camel::Dar::TMS::UserPosition::Type>(temp);
					}
					// Load Member nGameCount
					if (! Json_root["nGameCount"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nGameCount"], nGameCount))	{	return false;	}
					}
					// Load Member nRank
					if (! Json_root["nRank"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nRank"], nRank))	{	return false;	}
					}
					return true;
				}
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_UserInfo__MessageId_2961065544__

		#if !defined __Dar2MessageProtocol_TMS_UserRat__MessageId_3502944066__
		#define __Dar2MessageProtocol_TMS_UserRat__MessageId_3502944066__
		namespace TMS
		{
			class UserRat : public Camel::Dar2::IDarMsg
			{
			public:
				...
				bool _SaveSTREAM( Base::System::Stream::Handle stream)
				{
					...
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<__int64>( stream, llTotalPrizeChips))		{    return false;     }
					// Save Member nFinalWinCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nFinalWinCount))		{    return false;     }
					// Save Member nEntryWinCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nEntryWinCount))		{    return false;     }
					// Save Member nFinalEntryCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nFinalEntryCount))		{    return false;     }
					// Save Member nEntryCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nEntryCount))		{    return false;     }
					// Save Member bReserved
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<bool>( stream, bReserved))		{    return false;     }
				...
				bool _LoadSTREAM( Camel::Dar2::MessageBlock& clMessageBlock, bool bRequireChangeByteOrder = false)
				{
					...
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<__int64>( clMessageBlock, llTotalPrizeChips, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nFinalWinCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nFinalWinCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nEntryWinCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nEntryWinCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nFinalEntryCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nFinalEntryCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nEntryCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nEntryCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member bReserved
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<bool>( clMessageBlock, bReserved, bRequireChangeByteOrder))		{    return false;     }
					return true;
				}
				...
				bool LoadJSON(const Json::Value& Json_root)
				{
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["llTotalPrizeChips"], llTotalPrizeChips))	{	return false;	}
					}
					// Load Member nFinalWinCount
					if (! Json_root["nFinalWinCount"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nFinalWinCount"], nFinalWinCount))	{	return false;	}
					}
					// Load Member nEntryWinCount
					if (! Json_root["nEntryWinCount"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nEntryWinCount"], nEntryWinCount))	{	return false;	}
					}
					// Load Member nFinalEntryCount
					if (! Json_root["nFinalEntryCount"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nFinalEntryCount"], nFinalEntryCount))	{	return false;	}
					}
					// Load Member nEntryCount
					if (! Json_root["nEntryCount"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nEntryCount"], nEntryCount))	{	return false;	}
					}
					// Load Member bReserved
					if (! Json_root["bReserved"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["bReserved"], bReserved))	{	return false;	}
					}
					return true;
				}
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_UserRat__MessageId_3502944066__

		#if !defined __Dar2MessageProtocol_TMS_TournamentInfo__MessageId_1156134904__
		#define __Dar2MessageProtocol_TMS_TournamentInfo__MessageId_1156134904__
		namespace TMS
		{
			class TournamentInfo : public Camel::Dar2::IDarMsg
			{
			public:
				...
				{
					// Save Member nInning
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nInning))		{    return false;     }
					// Save Member eState
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<Camel::Dar::TMS::State::Type>( stream, eState))		{    return false;     }
					// Save Member nEntryCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nEntryCount))		{    return false;     }
					// Save Member nAliveCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<int>( stream, nAliveCount))		{    return false;     }
					// Save Member tStartTime
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<__int64>( stream, tStartTime))		{    return false;     }
					// Save Member tPlayTime
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<__int64>( stream, tPlayTime))		{    return false;     }
				...
				{
					// Load Member nInning
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nInning, bRequireChangeByteOrder))		{    return false;     }
					// Load Member eState
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<Camel::Dar::TMS::State::Type>( clMessageBlock, eState, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nEntryCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nEntryCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member nAliveCount
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<int>( clMessageBlock, nAliveCount, bRequireChangeByteOrder))		{    return false;     }
					// Load Member tStartTime
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<__int64>( clMessageBlock, tStartTime, bRequireChangeByteOrder))		{    return false;     }
					// Load Member tPlayTime
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<__int64>( clMessageBlock, tPlayTime, bRequireChangeByteOrder))		{    return false;     }
					return true;
				}
				...
				bool LoadJSON(const Json::Value& Json_root)
				{
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nInning"], nInning))	{	return false;	}
					}
					// Load Member eState
					if (! Json_root["eState"].isNull())
					{
						int temp;
						if (false == DAR2Rule_JSON::Load(Json_root["eState"], temp))	{	return false;	}
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["nAliveCount"], nAliveCount))	{	return false;	}
					}
					// Load Member tStartTime
					if (! Json_root["tStartTime"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["tStartTime"], tStartTime))	{	return false;	}
					}
					// Load Member tPlayTime
					if (! Json_root["tPlayTime"].isNull())
					{
						if (false == DAR2Rule_JSON::Load(Json_root["tPlayTime"], tPlayTime))	{	return false;	}
					}
					return true;
				}
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_TournamentInfo__MessageId_1156134904__

		#if !defined __Dar2MessageProtocol_TMS_ResultInfo__MessageId_1544121271__
		#define __Dar2MessageProtocol_TMS_ResultInfo__MessageId_1544121271__
		namespace TMS
		{
			class ResultInfo : public Camel::Dar2::IDarMsg
			{
			public:
				...
				bool _SaveSTREAM( Base::System::Stream::Handle stream)
				{
					...
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Save<__int64>( stream, llPrizeMoney))		{    return false;     }
				...
				bool _LoadSTREAM( Camel::Dar2::MessageBlock& clMessageBlock, bool bRequireChangeByteOrder = false)
				{
					...
					if (false ==  Camel::Dar2::DAR2Rule_STREAM::Load<__int64>( clMessageBlock, llPrizeMoney, bRequireChangeByteOrder))		{    return false;     }
					return true;
				}
				...
				bool LoadJSON(const Json::Value& Json_root)
				{
					...
					{
						if (false == DAR2Rule_JSON::Load(Json_root["llPrizeMoney"], llPrizeMoney))	{	return false;	}
					}
					return true;
				}
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_ResultInfo__MessageId_1544121271__

		#if !defined __Dar2MessageProtocol_TMS_SetMoneyInfo__MessageId_4024226605__
		#define __Dar2MessageProtocol_TMS_SetMoneyInfo__MessageId_4024226605__
		namespace TMS
		{
			class SetMoneyInfo : public Camel::Dar2::IDarMsg
			{
			public:
		...
		#endif     // !defined __Dar2MessageProtocol_TMS_SetMoneyInfo__MessageId_4024226605__
	}
}
