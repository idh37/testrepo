...
////////////////////////////클럽시스템 2017.12.21/////////////////////////////////////
//기존에 코드상 배열에 숫자를 집어넣고 있어, 해당 데이터가 여기저기 따로 정의될때, 유지보수시 문제가 발생할 여지가 있음.
//하여 이번부터 배열에 들어가는 바이트수를 이곳에 정의하여 공동으로 관리 하고자 함.
...
#define CHAR_BUFFER_PROMOTION_COMMON_ETC_DATA 30 //기타 정보를 담을 버퍼
#define CHAR_BUFFER_GAME_NAME 20 //훌라, 세븐포커등 게임 이름이 담김
#define CHAR_BUFFER_CHANNEL_NAME 20 //1억방, 3조방등 채널 이름이 담김
#define CHAR_BUFFER_REWARD_NAME 100 //치킨타임, 쿠폰등 보상되는 상품 이름이 담김
/////////////////////////////////////////////////

#define CHAR_BUFFER_DAYCODE_LEN 11 //yyyy-mm-dd 형식의 날짜 코드 버퍼이다.
#define CHAR_BUFFER_ETCDATA_LEN 255
#define CHAR_BUFFER_DATE_LEN 21 //yyyy-mm-dd hh:mm:ss 형식의 날짜 코드 버퍼이다.
...
#define CHAR_BUFFER_GOLD_INSURANCE_NAME 50 //골드보험 레벨명
////////////////////////////////

////////////////////////////골드출석부 CAPTCHA 2018.07.31/////////////////////////////////////
#define CHAR_BUFFER_CAPTCHA_KEY_LEN 512 //보안강화를 위해 캡차인증후 전달받는 키값 버퍼
/////////////////////////////////////
...
enum NEW_UPP_REASON
{
	//넷마블에서 DI 기준으로 UPP가 적용되었을때, 적용된 이유 코드이다.
	None = 0,
	Netmarble = 1, //넷마블정책
	OneSelf, //자기 자신이 걸었다.
	Family, //가족중 누군가가 걸었다.
	Organization, //국가 기관에서 걸었다.
	Etc, //기타 다른 이유이다.
};
/////////////////////////////////////////////////////////
...
{
	//출석 프로모션의 타입 코드
	ATTENDANCE_NORMAL = 1, //일반 누적
	ATTENDANCE_CONTINUE, //연속
};
