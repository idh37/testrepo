...
//	CGameHelperMan		m_cGameHelper;				// 게임 도우미
	...
	CPlayerDrawManager_SD	m_cPlayerDrawManager;   // 플레이어에대한 모든것을 그린다.(카드빼고)
	...
	//섯다용	
	CRadiophonograph	m_Radiophonograph;			//축음기
	CAnimationQue		m_AniQue;					//섯다용 애니메이션
	CAskRematch			m_cAskRematchPopup;			//재대결 조인 여부 질답창

	CChipBoard			m_cChipBoard;				//섯다 칩
