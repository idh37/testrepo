...
public:
	...
	void	ReSet();
	void	StartMove(NMBASE::GRAPHICGDI::xSprite *pSprite, CPoint ptStart, CPoint ptEnd, int nIndex, DWORD dwMoveTime, DWORD dwDelay, int opt = 0, float fPlayProportion = 1.0f);
