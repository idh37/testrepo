...
#define MAX_CHIPCNT (15) // 칩 종류

class CChip  
{
public:
	NMBASE::GRAPHICGDI::xSprite *m_pChipSpr;
	NMBASE::GRAPHICGDI::CPage *pPage, *pBatPage;

	// 칩 속성
	int ChipNo;			// 칩번호(0:안쓰임 1=1칩 2=5칩  3=10칩 4=50칩 5=100칩 6=500칩 7=1000칩)
	int Price;			// 칩의 금액
	int Kind;			// 칩의 각도별 종류
	int SprNo;			// 스프라이트 번호
	...
	void Init(NMBASE::GRAPHICGDI::CPage *ppage, NMBASE::GRAPHICGDI::CPage *pbatpage, NMBASE::GRAPHICGDI::xSprite *pChipSpr);
	void Clear();
